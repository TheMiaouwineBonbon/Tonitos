...
<svg xmlns="http://www.w3.org/2000/svg" width="${w}" height="${h}" viewBox="0 0 ${w} ${h}">
  <defs>
    ...
    <filter id="titleGlow" x="-10%" y="-40%" width="120%" height="180%">
      <feDropShadow dx="0" dy="0" stdDeviation="4" flood-color="#ffd96f" flood-opacity="0.9"/>
    </filter>
  </defs>
  ...
  <text x="70" y="84" font-family="Georgia, 'Times New Roman', serif" font-size="32" font-weight="700" fill="#20120e" stroke="#e7b94f" stroke-width="3" stroke-linejoin="round" paint-order="stroke fill" filter="url(#titleGlow)">${escapeXml(card.name)}</text>
