...
verifier(API?.cartes === 201, `Les 201 cartes du jeu sont détectées`, String(API?.cartes));
...
section("Quantités et feuilles");
{
  ...
  verifier(feuilles(201) === 23, "Le catalogue complet tient sur 23 feuilles");
  ...
  verifier(201 % API.PAR_FEUILLE === 3, "La dernière feuille du catalogue porte 3 cartes");
...
section("Rendu des cartes");
{
  ...
  verifier(toutes.length === 201, "201 cartes différentes au catalogue", String(toutes.length));
}
